...
<div class="CartButton">
    ...
    <v-expansion-panels v-model="panel" multiple>
        ...
        <v-expansion-panel>
            ...
            <v-expansion-panel-content style="background-color: #FFE7C2; padding: 10px; border: none">

                <div v-for="(address, index) in addresses" :key="index" style="
                    ...
                    <input type="radio" :value="'Address' + (index + 1)" :checked="selectedAddress === index" @change="selectAddress(index)" /><b>Address {{ index + 1 }}</b>
                    ...
                    <div v-show="editMode[index]">
                        ...
                        <v-text-field v-model="nameInputs[index]" label="Name"></v-text-field>

                        <v-text-field v-model="zipcodeInputs[index]" label="Zipcode"></v-text-field>

                        <v-text-field v-model="addressInputs[index]" label="Address"></v-text-field>
                        ...
                        " :disabled="loading" class="ma-1" color="grey" plain>
                            Cancel
                        </v-btn>
        ...
        <v-expansion-panel>
            ...
            <v-expansion-panel-content style="background-color: #FFE7C2; padding: 10px; border: none">
                ...
                <div>
                    ...
                    <input type="radio" id="Debit/Credit Card" value="Debit/Credit Card" v-model="selectedOption" />
                ...
                <div>
                    ...
                    <input type="radio" id="Pay On Delivery" value="Pay On Delivery" v-model="selectedOption" />
        ...
        <v-expansion-panel>
            ...
            <v-expansion-panel-content style="background-color: ; padding: 10px; border: none">

                <div v-if="selectedAddress !== -1">

                    <p>

                        <b>Selected Address:</b> {{ fullAddress(selectedAddress) }}</p>
