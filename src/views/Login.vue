                  ...
                  <v-row>
                    <v-col cols="12" md="6">
                      <v-card-text class="mt-12">
                        ...
                        <v-row ui align="center" justify="center">
                          <v-col cols="12" sm="8">
                      ...
                      > </v-checkbox>
                          ...
                          <v-btn color="#FF9933" dark block tile>Log in</v-btn>
                     
                         <h5
                          class="text-center  grey--text mt-4 mb-6"
                        >Or Log in using</h5>
                  ...
                  <v-row >
                    ...
                    <v-col cols="12" md="6">
                      <v-card-text class="mt-12">
                        ...
                        <!-- <h6
                          class="text-center  grey--text "
                        >Let's get you all set up so you can start creatinb your <br>
                      ...
                      > </v-checkbox>
                          ...
                          <v-btn color="#FF9933" dark block tile>Sign up</v-btn>
